...
public class House implements Rentable, Domestic {
    private String address;
    private double rentalRate;

    public House(String address, double rentalRate) {
    ...
    public static void main(String[] args) {
        // Because it implements Rentable, House can access its defined constants
